...
Just iam a power Full auto filter bot I am only working for my group 😅😅

For More Details Click Help Button Below..
@noughtyland
</i>"""    
    
    HELP_TEXT = """Just iam a power Full auto filter bot I am only working for my group 😅😅
...
<b>➥ Source Code</b> : <i><a href="Xrsirx5/autofilterbot">Click Me</a></i>
"""
